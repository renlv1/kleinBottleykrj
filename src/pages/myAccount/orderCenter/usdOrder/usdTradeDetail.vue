<template>
  <div class="usdTradeDetail">
    <div class="pc">
      <div class="pc-content">
        <div class="property-title">
          <h6><router-link to="/account/usdOrder" class="property">USD{{$t('usdOrder.text2')}} > </router-link><span class="transfer">{{$t('sieOrderDetail.text29')}}</span></h6>
        </div>
        <div class="order-progress">
          <h6>1.<span>{{tradeType(obj.etype)}}</span>{{$t('sieOrderDetail.text1')}}</h6>
    ...
    <div class="mobile">
      <div class="management-head">
        <div class="head">
          ...
          <div class="title">USD{{$t('sieOrderDetail.text29')}}</div>
          <div class="right"></div>
        </div>
      </div>
      <div class="mobile-content">
        <div class="order-progress">
          <h6><span>{{tradeType(obj.etype)}}</span>{{$t('sieOrderDetail.text1')}}</h6>
          <p><span >{{obj.tradeAmount | fourNumber}} <span v-if="obj.etype === 1">{{obj.buyCurrency}}</span><span v-if="obj.etype === 2">{{obj.sellCurrency}}</span>  </span> / <i>{{obj.amount | formattingMoney}} <span v-if="obj.etype === 1">{{obj.buyCurrency}}</span><span v-if="obj.etype === 2">{{obj.sellCurrency}}</span></i></p>
        </div>
