    ...
    <div class="pc">
      <div class="pc-content">
        <div class="property-title">
          <h6><router-link to="/account/sieOrder" class="property">USD{{$t('usdOrder.text2')}} > </router-link><span class="transfer">{{$t('sieOrder.text24')}}</span></h6>
        </div>
        <!--内部转账-->
        <table class="pcTableDetial">
          ...
          <tr>
            ...
            <td>{{totalValue | fourNumber}} USD</td>
          </tr>
          <tr>
          ...
          <!--收款账户 2和4转出 -->
          <tr v-if="recordType === 2 || recordType === 4">
    ...
    <div class="mobile">
      ...
      <div class="mobile-content">
        <div class="transfer-money">
          ...
          <p><span>{{totalValue | fourNumber}} </span> USD</p>
        </div>
        ...
        <div class="mobile-box">
          <ul>
            ...
            <!--收款账户-->
            <li v-if="recordType === 4 || recordType === 2">
