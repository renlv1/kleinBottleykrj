<template>
  <div class="usd-info">
    ...
    <div class="mobile-money">
      ...
      <h3 class="moneys" v-if="depositCurrency === 'BTC'">{{orderData.depositAmount | eightNumber}} {{depositCurrency}}</h3>
      <h3 class="moneys" v-if="depositCurrency !== 'BTC'">{{orderData.depositAmount | fourNumber}} {{depositCurrency}}</h3>
    ...
    <div id="order-table">
      <div class="pc-table">
        ...
        <div class="flex-item">
          ...
          <div v-if="depositCurrency === 'BTC'">{{orderData.depositAmount | eightNumber}} {{depositCurrency}}</div>
          <div v-if="depositCurrency !== 'BTC'">{{orderData.depositAmount | fourNumber}} {{depositCurrency}}</div>
        </div>
        <div class="flex-item">
        ...
        <div class="flex-item">
          ...
          <div v-if="orderData.depositCurrency !== 'BTC'">{{orderData.receiveAmount | fourNumber}} {{orderData.depositCurrency}}</div>
          <div v-if="orderData.depositCurrency === 'BTC'">{{orderData.receiveAmount | eightNumber}} {{orderData.depositCurrency}}</div>
        </div>
      </div>
      ...
      <div class="dialog-content" @click.stop>
        ...
        <div class="dialog-box">
          ...
          <div v-show="dakuanShow">
            ...
            <div class="pay-confim-btn" @click="daKuanConfim">{{$t('danAI.text12')}}</div>
          </div>
        </div>
      </div>
    </div>
      ...
      getOrderDetails () {
        this.postRequest('/deposit/depositDetail', {
          ...
          if (res.data.success === true) {
            ...
            if (this.orderData.depositCurrency !== 'BTC') {
