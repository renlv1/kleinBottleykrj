<template>
  <div class="usd-info">
    ...
    <div class="mobile-money">
      ...
      <h3 class="moneys">{{orderData.drawAmount}} {{orderData.payCurrency}}</h3>
    ...
    <div id="order-table">
      <div class="pc-table">
        ...
        <div class="flex-item">
          ...
          <div>{{orderData.drawAmount}} {{orderData.payCurrency}}</div>
        </div>
        <div class="flex-item">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      shenSuBtn() {
        this.$router.push({
          path: '/account/usdOrder/usdWithSwitchBoss/usdWithInfo/usdWithProblem',
          query: {
            id: this.orderId,
            isBTC: this.orderData.payCurrency
          }
        })
      },
